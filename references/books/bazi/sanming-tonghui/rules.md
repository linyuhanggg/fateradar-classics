...
- **rule_statement**：旬空由十干配十二支未到之位确定，如甲子旬戌亥；原文另分阴阳、前后与互换等法，空亡有用无用须看所空为福聚还是祸聚，不能逢空即凶、逢合即吉。
- **source_chapter**：vol-03/kongwang
- **applicable_to**：六亲、十神所在柱判断
- **caveats**：日旬查空是运行采用的口径，不代表本篇所有年日互换及阴阳分法。；祸聚欲空而忌合，福聚怕空而喜合；冲刑与同类冲不动另有条件，不写成无条件解空。；旬空、截路、四大空亡和五鬼等各有取法，不混用；主无依有变等泛化断语无对应本段依据。 原文 L1636–L1643。
- **verification_status**：pending_verification

## R-03-05 神煞总则

- **rule_statement**：神煞总论以生年纳音释身，须辨煞与本身的克临、生旺衰败及福神扶助；冲破合会可以转化福祸，吉凶神煞不可拘定。
- **source_chapter**：vol-03/zonglun-shensha
- **applicable_to**：所有神煞判断
- **caveats**：克身是本段煞下纳音克生年纳音，不直接等同克日干。；有官印或三奇禄马不保证贵，带七煞阳刃也不直接判贱；按原文条件分别记录。；产品只记神煞落柱、不作主格主用为产品口径，不冒称本段逐字结论。 原文 L1768–L1770。
- **verification_status**：pending_verification
...
- **rule_statement**：三奇篇并列乙丙丁、甲戊庚诸说，名称与顺逆取舍有分歧；须另论得体、得地、昼夜、贵神扶助及冲破，不能仅凭三干齐全定为有效贵格。
- **source_chapter**：vol-03/sanqi；原文 L1432–L1440
- **applicable_to**：神煞辅证
- **caveats**：正文以乙丙丁为天上三奇，亦认可甲戊庚天上说；批评甲戊庚地三奇及辛壬癸人间三奇说，不应写成统一天地人表。；先主顺布，后引广录乙时丙日丁年反贵并指出似不论顺逆；末诗癸壬辛与前文辛壬癸及其评价分歧保留。；乙丙丁夜生、甲戊庚昼生及得地、并贵、冲破等条件分别审视；才智贵贱为历史主张，未验证实际效果。；本条为八字篇章的文献归纳，不直接改动奇门三奇运行规则。
- **verification_status**：pending_verification

## R-03-08 太极贵人

- **rule_statement**：太极贵按甲乙子午、丙丁卯酉、庚辛寅亥、壬癸申巳及戊己四库论始终，又要求入格及福气贵神扶助，不能见支即断科名。
- **source_chapter**：vol-03/taiji-gui
- **applicable_to**：神煞辅证
- **caveats**：本段没有明确统一的年干日干并查指令，产品并查属于实现口径。；戊己喜生申、四库及四库全的表述分别保留；不据星名推断智慧或玄学天赋。 原文 L1463–L1465。
- **verification_status**：pending_verification

## R-03-09 学堂词馆

- **rule_statement**：学堂词馆篇并列纳音长生学堂、临官词馆及会禄会食等法，后引子平日干长生与四生支说；须分法考察得气、空亡、冲破及扶助。
- **source_chapter**：vol-03/xuetang-ciguan
- **applicable_to**：学业功名辅助
- **caveats**：甲亥乙午是学堂长生例，不能用于统一定义词馆。；首段纳音同类配柱与后文日干/四生取法不同，不能用单一查表替代整篇。；科名不专凭学堂词馆；保留甲辰一旬十二位等疑文，不作学业预测。 原文 L1474–L1492。
- **verification_status**：pending_verification

## R-03-10 正印（神煞）

- **rule_statement**：神煞篇正印为纳音五行正库，金见乙丑、木癸未、火甲戌、水土壬辰丙辰；依旺气、贵格、救助及空破等分别论诸印成败。
- **source_chapter**：vol-03/zhengyin
- **applicable_to**：古法神煞参考
- **caveats**：不是日干查单支，也不是十神正印或天印贵。；官印鬼印、福聚祸聚、自刑印均为篇内具体组合名称；不直接改动十神或地支刑算法。；水命本家印无益与首段本家印贵等差异保留，贵贱六亲断语未经现实验证。 原文 L1496–L1508。
- **verification_status**：pending_verification

## R-03-11 德秀

- **rule_statement**：德秀按月支三合组分别取德干和秀干，须无破冲克压，并考察学堂财官扶助；不能据单一德秀标签判定容貌品性。
- **source_chapter**：vol-03/dexiu
- **applicable_to**：神煞辅证
- **caveats**：申子辰德含壬癸戊己、秀含丙辛甲己，不仅壬癸。；冲克减力是原文明确限制，原己酉丑疑字保留。 原文 L1512–L1513。
- **verification_status**：pending_verification
