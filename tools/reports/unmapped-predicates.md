...
| `qizheng` | `xingming/xingming-suyuan` | `XR-01` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-01` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-004` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-005` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-006` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-007` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-009` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-010` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-02` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-015` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-016` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-03` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-022` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XR-04` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-04` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-026` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-028` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XR-05` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-05` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-031` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-033` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-034` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XR-06` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-06` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-037` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-038` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-039` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XR-07` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-XR-07` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-047` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
| `qizheng` | `xingming/xingming-suyuan` | `XINGMINGSUYU-048` | 需要引擎未产出的事实 | 五曜格局/行限/神煞/妇命专条，无对应 FactKey |
