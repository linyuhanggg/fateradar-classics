...
HEAD：`7491cb5d6d321efc325d0e4c756ff690204650ef`
draft 总数：**11993**
...
| 分类 | 条数 | 含义 |
| --- | ---: | --- |
| `verifiable_text` | 5803 | 可核实正文：电子原文完整可读，尚待完整语义对读 |
| `catalog_metadata` | 3945 | 目录/元数据：章题、卷端题署、版记或现代恢复说明，按 schema 保留 draft 状态 |
| `figure_or_lacuna` | 1952 | 图文缺失：含缺字、图像占位或残表标记 |
