...
HEAD：`9f3b00f51609b65b17bb47ba63b303ccf23b9bc6`
draft 总数：**12185**
...
| 分类 | 条数 | 含义 |
| --- | ---: | --- |
| `verifiable_text` | 5960 | 可核实正文：电子原文完整可读，尚待完整语义对读 |
| `catalog_metadata` | 3955 | 目录/元数据：章题、卷端题署、版记或现代恢复说明，按 schema 保留 draft 状态 |
| `figure_or_lacuna` | 1977 | 图文缺失：含缺字、图像占位或残表标记 |
