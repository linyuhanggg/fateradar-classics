...
HEAD：`69bb742ae755e55441a2e9a5f4bf70d028e9b3f6`
draft 总数：**12467**
...
| 分类 | 条数 | 含义 |
| --- | ---: | --- |
| `verifiable_text` | 6229 | 可核实正文：电子原文完整可读，尚待完整语义对读 |
| `catalog_metadata` | 3964 | 目录/元数据：章题、卷端题署、版记或现代恢复说明，按 schema 保留 draft 状态 |
| `figure_or_lacuna` | 1980 | 图文缺失：含缺字、图像占位或残表标记 |
