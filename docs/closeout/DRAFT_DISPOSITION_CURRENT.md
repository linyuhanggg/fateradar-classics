...
HEAD：`70097782b7ca65b5abfe30f7890372da618836da`
draft 总数：**13724**
...
| 分类 | 条数 | 含义 |
| --- | ---: | --- |
| `verifiable_text` | 6904 | 可核实正文：电子原文完整可读，尚待完整语义对读 |
| `catalog_metadata` | 4510 | 目录/元数据：章题、卷端题署、版记或现代恢复说明，按 schema 保留 draft 状态 |
| `figure_or_lacuna` | 2016 | 图文缺失：含缺字、图像占位或残表标记 |
