...
精确 SHA 随本提交。基线 `5449b299` 为 81,417 段；t125 后 83,351；本批 t167 后源段 **120,017**，注释仍 **88,492**（白话不再阻塞原文）。

## 独立重算

源段 **120,017**，注释 88,492；无注释源段 31,525（原文已入库，不等白话）；悬空注释 ID 0。source-reviewed 74,529，draft 13,963 只描述既有白话注释，**不再当原文剩余工作**。source-reviewed 不等于影印复核。

catalogComplete=false 仅 **SK1610**（13 章识典无 paragraphList，重试仍失败；另 80 章为站方计数与实收不符，不是缺了 80 章）。其余本批入库版本网页目录已齐，**不是**古本全帙。详情 `docs/closeout/SOURCE-LIBRARY-DELIVERY-20260916.md`。
...
- t135 SDZJ0170《紫微斗数全书》缺章继续分批合入：4 章 / 75 新段（43 source-reviewed / 32 draft）。本版 1,419→1,494 段；仍余 139 章 / 640 段未合入，`catalogComplete` 仍 false。
- t136 SDZJ0170《紫微斗数全书》缺章继续分批合入：6 章 / 171 新段（103 source-reviewed / 68 draft）。本版 1,494→1,665 段；仍余 133 章 / 469 段未合入，`catalogComplete` 仍 false。
- t137 SDZJ0170《紫微斗数全书》缺章继续分批合入：14 章 / 124 新段（74 source-reviewed / 50 draft）。本版 1,665→1,789 段；仍余 119 章 / 345 段未合入，`catalogComplete` 仍 false。
...
- t147 HY2301《御纂周易折中》缺章继续分批合入：6 章 / 124 新段（117 source-reviewed / 7 draft）。本版 1,272→1,396 段；仍余 35 章 / 698 段未合入，`catalogComplete` 仍 false。
- t148 HY2301《御纂周易折中》缺章继续分批合入：6 章 / 110 新段（103 source-reviewed / 7 draft）。本版 1,396→1,506 段；仍余 29 章 / 588 段未合入，`catalogComplete` 仍 false。
- t149 HY2301《御纂周易折中》缺章继续分批合入：5 章 / 90 新段（86 source-reviewed / 4 draft）。本版 1,506→1,596 段；仍余 24 章 / 498 段未合入，`catalogComplete` 仍 false。
- t150 HY2301《御纂周易折中》缺章继续分批合入：4 章 / 60 新段（53 source-reviewed / 7 draft）。本版 1,596→1,656 段；仍余 20 章 / 438 段未合入，`catalogComplete` 仍 false。
- t151 HY2301《御纂周易折中》缺章继续分批合入：3 章 / 136 新段（131 source-reviewed / 5 draft）。本版 1,656→1,792 段；仍余 17 章 / 302 段未合入，`catalogComplete` 仍 false。
- t152 HY2301《御纂周易折中》缺章继续分批合入：12 章 / 176 新段（175 source-reviewed / 1 draft）。本版 1,792→1,968 段；仍余 5 章 / 126 段未合入，`catalogComplete` 仍 false。
...
- t157 7533808921945833506《五行精纪》缺章继续分批合入：21 章 / 84 新段（37 source-reviewed / 47 draft）。本版 752→836 段；仍余 385 章 / 2,525 段未合入，`catalogComplete` 仍 false。
- t158 7533808921945833506《五行精纪》缺章继续分批合入：26 章 / 138 新段（67 source-reviewed / 71 draft）。本版 836→974 段；仍余 359 章 / 2,387 段未合入，`catalogComplete` 仍 false。
- t159 7533808921945833506《五行精纪》缺章继续分批合入：23 章 / 112 新段（53 source-reviewed / 59 draft）。本版 974→1,086 段；仍余 336 章 / 2,275 段未合入，`catalogComplete` 仍 false。
- t160 7533808921945833506《五行精纪》缺章继续分批合入：40 章 / 119 新段（41 source-reviewed / 78 draft）。本版 1,086→1,205 段；仍余 296 章 / 2,156 段未合入，`catalogComplete` 仍 false。
- t161 7533808921945833506《五行精纪》缺章继续分批合入：12 章 / 40 新段（16 source-reviewed / 24 draft）。本版 1,205→1,245 段；仍余 284 章 / 2,116 段未合入，`catalogComplete` 仍 false。
- t162 7533808921945833506《五行精纪》缺章继续分批合入：16 章 / 321 新段（16 source-reviewed / 305 draft）。本版 1,245→1,566 段；仍余 268 章 / 1,795 段未合入，`catalogComplete` 仍 false。
- t163 7533808921945833506《五行精纪》缺章继续分批合入：21 章 / 124 新段（0 source-reviewed / 124 draft）。本版 1,566→1,690 段；仍余 247 章 / 1,671 段未合入，`catalogComplete` 仍 false。
- t164 7533808921945833506《五行精纪》缺章继续分批合入：8 章 / 121 新段（0 source-reviewed / 121 draft）。本版 1,690→1,811 段；仍余 239 章 / 1,550 段未合入，`catalogComplete` 仍 false。
- t165 7533808921945833506《五行精纪》缺章继续分批合入：14 章 / 96 新段（0 source-reviewed / 96 draft）。本版 1,811→1,907 段；仍余 225 章 / 1,454 段未合入，`catalogComplete` 仍 false。
- t166 7533808921945833506《五行精纪》缺章继续分批合入：19 章 / 143 新段（0 source-reviewed / 143 draft）。本版 1,907→2,050 段；仍余 206 章 / 1,311 段未合入，`catalogComplete` 仍 false。
...
1. 已下载 staged 原文已入库（t167，+31,525）。白话不再阻塞原文。
2. 三命通会 SK1610 仍缺 13 章识典 SSR 无 paragraphList（期望约 75 段），重试失败有记录。
3. 图像占位未转写；0803.djvu 己/巳 为版本异文，原字保留。
4. 网页目录取齐不是古本全帙，不以 CI 代替影印校勘。
