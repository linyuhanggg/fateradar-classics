# A1 未决项逐条索引（《總鈐》残格 ＋ 未确认影印底本 16 套）

> **2026-09-14：** JSON 已改：總鈐 **664**；L1010／L1038 改为「十二月神煞疑字」，不是残格。下表 666 是 2026-09-13 历史口径。当前消费以 JSON 与 `t30-pending-typed-disposition-20260914.json` 为准。
