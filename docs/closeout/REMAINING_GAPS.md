...
本文件随提交记录 HEAD `a15c6672a4c41e50d6761880fb87a0d228ff7c91` 的重算：源段与注释 **87,416**；未注释、重复、悬空 ID 均 0；
source-reviewed **74,403**；draft **13,013**。
...
| draft | **13,013** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,478、catalog_metadata 4,226、figure_or_lacuna 2,015、edition_variant 293、illegible 1。 |
...
| source-reviewed | 74,403 | 不等于影印精校。 |
...
| 7533808921945833506 | 974 | 3,361 | 2,387 未合入 | 0 |
