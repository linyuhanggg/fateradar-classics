...
本文件随提交记录 HEAD `91f1abe33963be6c062d992e3206eb4427e4ad3e` 的重算：源段与注释 **88,132**；未注释、重复、悬空 ID 均 0；
source-reviewed **74,529**；draft **13,603**。
...
| draft | **13,603** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,814、catalog_metadata 4,480、figure_or_lacuna 2,015、edition_variant 293、illegible 1。 |
...
| 7533808921945833506 | 1,690 | 3,361 | 1,671 未合入 | 0 |
