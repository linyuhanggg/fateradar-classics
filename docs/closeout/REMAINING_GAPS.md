...
本文件随提交记录 HEAD `2f701413395d7a0c866e20fb92155b2559465ac1` 的重算：源段与注释 **87,278**；未注释、重复、悬空 ID 均 0；
source-reviewed **74,336**；draft **12,942**。
...
| draft | **12,942** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,452、catalog_metadata 4,182、figure_or_lacuna 2,014、edition_variant 293、illegible 1。 |
...
| source-reviewed | 74,336 | 不等于影印精校。 |
...
| 7533808921945833506 | 836 | 3,361 | 2,525 未合入 | 0 |
