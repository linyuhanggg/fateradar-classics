...
本文件随提交记录 HEAD `e3e601bae03690ec7389a5f3172632906f7dd385` 的重算：源段与注释 **88,008**；未注释、重复、悬空 ID 均 0；
source-reviewed **74,529**；draft **13,479**。
...
| draft | **13,479** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,718、catalog_metadata 4,452、figure_or_lacuna 2,015、edition_variant 293、illegible 1。 |
...
| 7533808921945833506 | 1,566 | 3,361 | 1,795 未合入 | 0 |
