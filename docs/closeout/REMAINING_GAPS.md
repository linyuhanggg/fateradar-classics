...
本文件随提交记录 HEAD `c8092c8440e1265c070ab17e1ba40825be00e374` 的重算：源段与注释 **87,687**；未注释、重复、悬空 ID 均 0；
source-reviewed **74,513**；draft **13,174**。
...
| draft | **13,174** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,553、catalog_metadata 4,312、figure_or_lacuna 2,015、edition_variant 293、illegible 1。 |
...
| source-reviewed | 74,513 | 不等于影印精校。 |
...
| 7533808921945833506 | 1,245 | 3,361 | 2,116 未合入 | 0 |
