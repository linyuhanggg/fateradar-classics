...
本文件随提交记录 HEAD `b251cdcf9c1f2669f8ffefa507eea46d70dd25f5` 的重算：源段与注释 **86,497**；未注释、重复、悬空 ID 均 0；
source-reviewed **73,799**；draft **12,698**。
...
| draft | **12,698** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,315、catalog_metadata 4,108、figure_or_lacuna 1,981、edition_variant 293、illegible 1。 |
...
| source-reviewed | 73,799 | 不等于影印精校。 |
