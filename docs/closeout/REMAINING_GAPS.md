...
本文件随提交记录 HEAD `af64edfbb4f1e9ecf3201b829c014b608d907fc3` 的重算：源段与注释 **85,848**；未注释、重复、悬空 ID 均 0；
source-reviewed **73,217**；draft **12,631**。
...
| draft | **12,631** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,296、catalog_metadata 4,060、figure_or_lacuna 1,981、edition_variant 293、illegible 1。 |
...
| source-reviewed | 73,217 | 不等于影印精校。 |
...
| HY2301 | 1,007 | 2,094 | 1,087 未合入 | 0 |
