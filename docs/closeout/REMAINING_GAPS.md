...
本文件随提交记录 HEAD `d82f6c6d0c701cf5143148ff1eb82bbf34328c71` 的重算：源段与注释 **87,647**；未注释、重复、悬空 ID 均 0；
...
| draft | **13,150** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,542、catalog_metadata 4,299、figure_or_lacuna 2,015、edition_variant 293、illegible 1。 |
...
| source-reviewed | 74,497 | 不等于影印精校。 |
...
| 7533808921945833506 | 1,205 | 3,361 | 2,156 未合入 | 0 |
