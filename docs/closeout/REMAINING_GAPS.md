...
本文件随提交记录 HEAD `e09d49777b1fff543689b46313963133c3a8e557` 的重算：源段与注释 **85,761**；未注释、重复、悬空 ID 均 0；
source-reviewed **73,153**；draft **12,608**。
...
| draft | **12,608** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,292、catalog_metadata 4,041、figure_or_lacuna 1,981、edition_variant 293、illegible 1。 |
...
| source-reviewed | 73,153 | 不等于影印精校。 |
