...
本文件随提交记录 HEAD `18856cff48f7592cb762f7e43c4c96f2a6bbab76` 的重算：源段与注释 **87,194**；未注释、重复、悬空 ID 均 0；
source-reviewed **74,299**；draft **12,895**。
...
| draft | **12,895** | 逐条处置账已建（`DRAFT_DISPOSITION_LEDGER.json`，12,097 行全覆盖，每行带源 ID、证据路径与分类依据），**分类不是结案**。分类计数：verifiable_text 6,425、catalog_metadata 4,162、figure_or_lacuna 2,014、edition_variant 293、illegible 1。 |
...
| source-reviewed | 74,299 | 不等于影印精校。 |
...
| 7533808921945833506 | 752 | 3,361 | 2,609 未合入 | 0 |
