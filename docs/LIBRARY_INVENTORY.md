...
| divination | bushi-zhengzong | 卜筮正宗 | 是 | 9 | 0 | 0 | 0 | engine | 已存影印／候选底本 |
...
| luming-nayin | luoluzi-sanming | 珞琭子三命消息赋 | 是 | 156 | 0 | 0 | 0 | knowledge | 已存影印／候选底本 |
...
| selection | xieji-bianfang-shu | 协纪辨方书 | 是 | 2399 | 0 | 0 | 0 | knowledge | 已存影印／候选底本 |
