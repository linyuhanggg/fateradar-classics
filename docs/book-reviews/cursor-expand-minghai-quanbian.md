...
- 网站卷六 198/238、卷之六 40/75 已写子平骨髓歌、起运与丑月起例；仍缺卷六中段 40 与卷之六后 35。
- 其余 224 段（卷六空洞、卷之六后段、卷八、卷十）仍在按章重写。全文件 substantively 处理完毕且必要 validator 通过前，不写 `WORK_PACKAGE_COMPLETE`。
