...
- 网站卷八 40/148：已写诸格集解取格目录、用神所忌、正官/偏官/七煞/印绶/正财。卷端五图 draft+unknown。网站题卷八而卷端作卷之七。
- 其余 109 段（卷八后 108、卷十 1）仍在按章对照原文重写。全文件实质处理完毕且必要 validator 通过前，不写 `WORK_PACKAGE_COMPLETE`。
