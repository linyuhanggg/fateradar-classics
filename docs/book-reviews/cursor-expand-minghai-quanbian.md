...
- 网站卷之一已完成前 120/223：上两批之后续写十二要法田宅至相貌、琴堂先排太阳、度主为要、五贱星、令星得令与水火无相生、一星得地、奴仆宫主不可一例、杀前主后、迟进伏逆、罗计截断/孤君、日垣为妻时垣为子女、八煞可为权柄、贵命一星得用。两处图像段保持 draft + unknown。
- 其余 885 段仍在按章重写。全文件 substantively 处理完毕且必要 validator 通过前，不写 `WORK_PACKAGE_COMPLETE`。
