...
- 网站二卷已完成 229/229：卷端题署、历法躔度与十二宫断、宿度名号、二卷终与望斗待收篇目。图像/残图保持 draft + unknown。
- 其余 553 段（卷之三起）仍在按章重写。全文件 substantively 处理完毕且必要 validator 通过前，不写 `WORK_PACKAGE_COMPLETE`。
