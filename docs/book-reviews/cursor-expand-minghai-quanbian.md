...
- 网站卷之一已完成前 80/223：前 40 为题署、十二宫、安命数卯/安身数酉、十一主、余星救主、果老问答 1–12；续 40 为果老 13–14、斗杓卦气唐符国印、凶死取象、行限生克、满而不载、太岁当头、空亡救援、十二长生、小儿关、流星须参原守、大小限岁数、倒限须二恶并见、寿不以限度定、竹罗三限昼夜分主、十二要法一看二看。图像段保持 draft + unknown。
- 其余 925 段仍在按章重写。全文件 substantively 处理完毕且必要 validator 通过前，不写 `WORK_PACKAGE_COMPLETE`。
