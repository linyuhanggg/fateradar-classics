...
- 已完成：扉页 3 + 序与目录 425 + 神異賦 261 + 卷之六 3 + 金鎻賦 5 + 卷十二题署 3 + 黄色吉㐫相 48 = **748 / 748**。
- 累计完成 / 剩余：748 / 0。账本 `remainingIds` 已空。
- 本文件 748 段均已对照原文重写或核验保留；`verified` 仍全部 false。结构校验通过不是语义证书，仍待 integration 复核。

## 本轮收尾要点

- 金鎻賦：水星救护、两头无克才「假饶凶处不为凶」、僧道孤门却无妨、反吟伏吟是鼻形；银匙歌标 mixed-in。
- 黄色吉㐫相：官/庶、四季、七日/七十日/七旬分套；冬黄绕口凶 vs 满面吉；黄入口主疾 vs 承浆喜；中阳先凶后吉；女印堂形厚晚达 vs 肤薄少昌；驿马=眉上一寸。
- 疑文 unknown（不发明）：□（卷十二题）、怡偏斜、兢妻、𡮢、𢀴、𩚼饪、觀祭使、人门、入句、并中/正如句读、女人有此亦无有、喜色连鼻句读等。
