...
- 最终提交：`9ba6b563a6c64193d9f89d5badf8f38d14c66584`
...
- 可执行规则 46 条，全部 `verified: false`
  - 八字：ZPR-E-01..17、QTB-E-01、SMTH-E-01 天乙落柱、SMTH-E-02 驿马落柱、SMTH-E-03 咸池桃花落柱、SMTH-E-04 华盖落柱、SMTH-E-05 将星落柱、SMTH-E-06 孤辰落柱、SMTH-E-07 寡宿落柱、SMTH-E-08 劫煞落柱、SMTH-E-09 亡神落柱、SMTH-E-10 灾煞落柱
  - 紫微：ZWD-E-01 生年干四化落宫
...
- 神煞除天乙、驿马、桃花、华盖、将星、孤辰、寡宿、劫煞、亡神、灾煞落柱外仍是名单
...
- `references/executable/sanming-tonghui.json`：SMTH-E-01 天乙、SMTH-E-02 驿马、SMTH-E-03 桃花、SMTH-E-04 华盖、SMTH-E-05 将星、SMTH-E-06 孤辰、SMTH-E-07 寡宿、SMTH-E-08 劫煞、SMTH-E-09 亡神、SMTH-E-10 灾煞
- 盘点脚本重跑，可执行规则 43→46
- 不改 `sources/` 原文
...
executable_rules_in_this_commit 46, knowledge packs 33
verified_rules 0
...
`L1346-L1353` 驿马、`L1234-L1238` 咸池桃花、`L1225-L1232` 华盖将星、`L1690-L1701` 孤辰寡宿、`L1515-L1520` 劫煞亡神、`L1676-L1678` 灾煞：只记落柱，不是行程、品行、孤独、婚配、祖业、贫穷、横祸或公卿结论。
