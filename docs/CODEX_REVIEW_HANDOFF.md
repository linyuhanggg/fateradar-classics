...
- 最终提交：`678db406dedcf6d0700aad19ec5761aa3c7ce74b`
...
- 通根仍按藏干本气中气余气分档，未按阳干逢库有根、阴干逢库无用覆盖；印根、伤官旺、财有根只记透藏；身强不按旺衰分层覆盖；财印位置只记相并或有隔；食神、阳刃、建禄、印格、财格成路只记透藏；阳刃无官煞、建禄无财官透煞印、食神生财露煞只记透藏；用神变化只记丁亥卯未、己申透壬；变之善不善只记辛寅逢丙、壬戌逢辛、丙寅会午戌、丙申会子辰；变而不失本格、用神纯杂只记并透，透甲兼格不是成格结论，化为印、化财为官不是已经改格；格局高低只记原文透藏，合伤存官不是成格结论；因成得败只记原文例，卯未会财不是破格结论；相神紧要、用神配气候未论，印轻官旺未论，仍不能成格/破格
...
executable_rules_in_this_commit 80, knowledge packs 33
verified_rules 0
...
- 食神、阳刃、建禄、印格、财格成路只记透藏；阳刃无官煞、建禄无财官透煞印、食神生财露煞只记透藏；用神变化只记丁亥卯未、己申透壬；变之善不善只记辛寅逢丙、壬戌逢辛、丙寅会午戌、丙申会子辰；变而不失本格、用神纯杂只记并透；格局高低只记原文透藏；因成得败只记原文例；不见伤官不是成格结论；无官煞不是败格结论；化为印、化财为官不是已经改格；透甲兼格不是成格结论；合伤存官不是成格结论；建禄格仍为格局不清；相神紧要、用神配气候未论；印轻、官旺未论
