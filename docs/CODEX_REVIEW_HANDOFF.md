> 2026-09-12 用户已停止 Multica，并授权阶段成果合入 main。当前完成与未完成范围以 [CLOSEOUT_20260912.md](CLOSEOUT_20260912.md) 为准；下文旧接续/未合main状态仅供历史追溯。

# Codex 验收交接 · 古籍仓

> 当前施工状态：下文保留首次交付与接手记录。当前按完整方案在 `codex/full-library-completion` 持续施工，尚未总验收、未合main、未部署；最新真实进度、两仓版本、复现检查与剩余范围以 [GOAL_PROGRESS.md](GOAL_PROGRESS.md) 为准。已加入整书语义、独立恢复版本、原书最小组件案例与实际产品消费者，不能沿用旧记录判断当前已完成或未完成范围。
...
- 最终提交：`98471405d7cabcde08ee0a05fdad6fa551532244`
...
- 通根仍按藏干本气中气余气分档，未按阳干逢库有根、阴干逢库无用覆盖；印根、伤官旺、财有根只记透藏；身强不按旺衰分层覆盖；财印位置只记相并或有隔；食神、阳刃、建禄、印格、财格成路只记透藏；阳刃无官煞、建禄无财官透煞印、食神生财露煞只记透藏；用神变化只记丁亥卯未、己申透壬；变之善不善只记辛寅逢丙、壬戌逢辛、丙寅会午戌、丙申会子辰；变而不失本格、用神纯杂只记并透，透甲兼格不是成格结论，化为印、化财为官不是已经改格；格局高低只记原文透藏，合伤存官不是成格结论；因成得败只记原文例，卯未会财不是破格结论；用神配气候只记原文透藏，不覆盖调候表；相神紧要只记原文透藏，全赖壬相不是成格结论；杂气取用未论，印轻官旺未论，仍不能成格/破格
...
- `references/executable/ziping-zhenquan.json`：ZPR-E-18 通根阳库分条、ZPR-E-19 印根透藏、ZPR-E-20 身强来源分条、ZPR-E-21 伤官旺透藏、ZPR-E-22 财有根透藏、ZPR-E-23 财印位置分条、ZPR-E-24 食神成路透藏、ZPR-E-25 阳刃成路透藏、ZPR-E-26 建禄月劫成路透藏、ZPR-E-27 印格成路透藏、ZPR-E-28 财格成路透藏、ZPR-E-29 阳刃无官煞败格透藏、ZPR-E-30 建禄无财官透煞印败格透藏、ZPR-E-31 食神生财露煞败格透藏、ZPR-E-32 用神变化分条、ZPR-E-33 变之善不善分条、ZPR-E-34 变而不失本格分条、ZPR-E-35 用神纯杂分条、ZPR-E-36 格局高低分条、ZPR-E-37 因成得败因败得成分条、ZPR-E-38 用神配气候分条、ZPR-E-39 相神紧要分条
- 盘点脚本重跑，可执行规则 80→82
- 不改 `sources/` 原文
...
executable_rules_in_this_commit 82, knowledge packs 33
verified_rules 0
...
《子平真诠》`ziping-zhenquan:L0192-L0192` 通根：阳干逢库有根、阴干逢库无用、投库必冲为俗书之谬。本盘仍按藏干本气中气余气分档，墓库须冲开不覆盖。`L1223-L1223` 印根只记透藏，本气不是已经根深。`L0365-L0368` 身强与旺衰四层分条。`L0369` 伤官旺、`L1217` 财有根只记透藏。`L0365` 财印位置只记透干相并或有隔，有隔不是已经位置妥贴。`L0367` 食神成路、`L0370` 阳刃成路、`L0371` 建禄月劫成路、`L0366` 印格成路、`L0365` 财格成路只记透藏。`L0380` 阳刃无官煞、`L0381` 建禄无财官透煞印、`L0377` 食神生财露煞只记透藏。`L0421` 用神变化只记丁生亥月支全卯未、己生申月藏庚透壬，化为印不是已经改格。`L0426-L0432` 变之善不善只记辛生寅月逢丙、壬生戌月逢辛、丙生寅月甲不透会午戌、丙生申月透壬会子辰，化财为官、化为劫不是已经改格。`L0435-L0439` 变而不失本格只记并透，透甲兼格不是成格结论，格不破不是破格结论。`L0452-L0454` 用神纯杂只记并透，甲丙并透不是已经论纯。`L0468-L0470` 格局高低只记原文透藏，合伤存官不是成格结论，辛丁并透不是已经论有力。`L0490-L0492` 因成得败因败得成只记原文例，卯未会财不是破格结论，年丙时壬不是成格结论。`L0504-L0512` 用神配气候只记原文透藏，透丁为官不是成格结论，木火通明不是已经调候，不覆盖调候表。`L0525-L0532` 相神紧要只记原文透藏，全赖壬相不是成格结论，相神有伤不是破格结论。杂气取用未论。印轻、官旺未论。不成格不破格。
...
- 身强不按得令得地得势分层覆盖
- 财印位置只记透干相并或有隔；有隔不是已经位置妥贴，相并不是已经两不相能
- 食神、阳刃、建禄、印格、财格成路只记透藏；阳刃无官煞、建禄无财官透煞印、食神生财露煞只记透藏；用神变化只记丁亥卯未、己申透壬；变之善不善只记辛寅逢丙、壬戌逢辛、丙寅会午戌、丙申会子辰；变而不失本格、用神纯杂只记并透；格局高低只记原文透藏；因成得败只记原文例；用神配气候只记原文透藏，不覆盖调候表；相神紧要只记原文透藏；不见伤官不是成格结论；无官煞不是败格结论；化为印、化财为官不是已经改格；透甲兼格不是成格结论；合伤存官不是成格结论；透丁为官不是成格结论；全赖壬相不是成格结论；建禄格仍为格局不清；杂气取用未论；印轻、官旺未论
