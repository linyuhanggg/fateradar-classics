...
- 最终提交：`dc62a4e0d43b652fed93190503f01ed6e84dd6de`
...
- 通根仍按藏干本气中气余气分档，未按阳干逢库有根、阴干逢库无用覆盖；印根、伤官旺、财有根只记透藏；身强不按旺衰分层覆盖；财印位置只记相并或有隔，有隔不是已经位置妥贴，仍不能成格/破格
...
- `references/executable/ziping-zhenquan.json`：ZPR-E-18 通根阳库分条、ZPR-E-19 印根透藏、ZPR-E-20 身强来源分条、ZPR-E-21 伤官旺透藏、ZPR-E-22 财有根透藏、ZPR-E-23 财印位置分条
- 盘点脚本重跑，可执行规则 65→66
- 不改 `sources/` 原文
...
executable_rules_in_this_commit 66, knowledge packs 33
verified_rules 0
...
《子平真诠》`ziping-zhenquan:L0192-L0192` 通根：阳干逢库有根、阴干逢库无用、投库必冲为俗书之谬。本盘仍按藏干本气中气余气分档，墓库须冲开不覆盖。`L1223-L1223` 印根只记透藏，本气不是已经根深。`L0365-L0368` 身强与旺衰四层分条。`L0369` 伤官旺、`L1217` 财有根只记透藏。`L0365` 财印位置只记透干相并或有隔，有隔不是已经位置妥贴。不成格。
