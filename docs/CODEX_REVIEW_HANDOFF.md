...
- 最终提交：`43b340e29c47dd4a7e98b10ee43089d29ba13d42`
...
- 可执行规则 53 条，全部 `verified: false`
  - 八字：ZPR-E-01..17、QTB-E-01、SMTH-E-01 天乙落柱、SMTH-E-02 驿马落柱、SMTH-E-03 咸池桃花落柱、SMTH-E-04 华盖落柱、SMTH-E-05 将星落柱、SMTH-E-06 孤辰落柱、SMTH-E-07 寡宿落柱、SMTH-E-08 劫煞落柱、SMTH-E-09 亡神落柱、SMTH-E-10 灾煞落柱、SMTH-E-11 天喜来源分条、SMTH-E-12 金舆落柱、SMTH-E-13 羊刃落柱、SMTH-E-14 飞刃落柱、SMTH-E-15 禄神落柱、SMTH-E-16 天德落柱、SMTH-E-17 月德落柱
  - 紫微：ZWD-E-01 生年干四化落宫
...
- 神煞除已接入落柱的条目外仍有名单未抽；天喜未按四季覆盖；阴干羊刃未按子平无刃覆盖；文昌学堂与原文取法未对齐
...
- `references/executable/sanming-tonghui.json`：SMTH-E-01..17
- 盘点脚本重跑，可执行规则 51→53
- 不改 `sources/` 原文
...
executable_rules_in_this_commit 53, knowledge packs 33
verified_rules 0
...
`L1620-L1624` 羊刃飞刃、`L1295-L1299` 十干禄、`L3655-L3659` 天月二德：只记落柱，不是性情、倒戈、爵禄、无险或福寿。
